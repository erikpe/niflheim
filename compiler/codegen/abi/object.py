...
def type_debug_name_operand(type_register: str) -> str:
    return stack_slot_operand(type_register, RT_TYPE_DEBUG_NAME_OFFSET)
...
def interface_debug_name_operand(interface_register: str) -> str:
    return stack_slot_operand(interface_register, RT_INTERFACE_DEBUG_NAME_OFFSET)
...
def interface_method_entry_operand(method_table_register: str, slot_index: int) -> str:
    ...
    return stack_slot_operand(method_table_register, slot_index * RT_INTERFACE_METHOD_ENTRY_SIZE_BYTES)
