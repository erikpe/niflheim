...
def require_semantic_main_function(program: SemanticCodegenProgram) -> None:
    main_decl = next(
        (
            fn
...
def build_semantic_codegen_program(program: SemanticProgram) -> SemanticCodegenProgram:
