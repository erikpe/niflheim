...
- [docs/INLINE_INTERFACE_DISPATCH_PLAN.md](docs/INLINE_INTERFACE_DISPATCH_PLAN.md)
- [docs/OVERRIDE_VIRTUAL_DISPATCH_PLAN.md](docs/OVERRIDE_VIRTUAL_DISPATCH_PLAN.md)
