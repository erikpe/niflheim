...
These examples are intentionally small and map to MVP v0.1 language goals.
...
- `03_vec_and_map.nif` - boxed primitives, `Vec`, `Map`, identity-key semantics.
...
Note: syntax is aligned to the current MVP docs and may evolve while the parser is implemented.
