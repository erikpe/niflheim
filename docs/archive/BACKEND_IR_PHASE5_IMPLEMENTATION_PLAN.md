...
Historical note: phase 6 PR 1 completed the default checked-path cutover. Selector-based commands in this document describe the phase-5 parity gate, not the current repository default.

This document expands phase 5 from [docs/archive/BACKEND_IR_TRANSITION_PLAN.md](BACKEND_IR_TRANSITION_PLAN.md) into a concrete implementation checklist with PR-sized slices.
